  ...
  return (
    <div className="min-h-screen ">
      ...
      <div className="max-w-6xl mt-20 mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-3xl md:text-3xl mb-4 font-extrabold bg-gradient-to-tr from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
          Your
          <span className="mx-2">Brandify</span>
          Logo History
        </div>
